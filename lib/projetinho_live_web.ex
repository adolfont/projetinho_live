defmodule ProjetinhoLiveWeb do
  @moduledoc """
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/projetinho_live_web/templates",
        namespace: ProjetinhoLiveWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ProjetinhoLiveWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import ProjetinhoLiveWeb.ErrorHelpers
      import ProjetinhoLiveWeb.Gettext
      alias ProjetinhoLiveWeb.Router.Helpers, as: Routes
    end
  end
